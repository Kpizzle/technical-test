...
public class VowelCounter {
    ...
    public List<CountResult> getVowelListWithCount(String[] args) {
        if (args.length >= 4) {
            ...
            argumentList.forEach(argument -> vowelCount.add(new CountResult(argument, getVowelCount(argument), getConsonantsCount(argument))));
            return vowelCount;
        }
    }
    ...
    private Integer getConsonantsCount(String input){
        String[] inputChars = input.split("");
